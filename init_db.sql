-- 创建数据库
CREATE DATABASE IF NOT EXISTS db_409252614;

-- 使用数据库
USE db_409252614;

-- 创建商品表
CREATE TABLE IF NOT EXISTS products (id INT AUTO_INCREMENT PRIMARY KEY,name VARCHAR(255) NOT NULL,description TEXT,price DECIMAL(10, 2) NOT NULL,image VARCHAR(255),tags VARCHAR(255),created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
...
-- 插入示例商品数据
INSERT IGNORE INTO products (id, name, description, price, image) VALUES 
